...
<body class="fix-header">
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
				...
				<div class="row" id="gestionAvion" style="display: none">
					<div class="col-md-12 col-lg-12 col-sm-12">
						<div class="white-box">
				...
				<div class="row" id="gestionVuelos" style="display: none">
					<div class="col-md-12 col-lg-12 col-sm-12">
						<div class="white-box">
				...
				<div class="col-md-12 col-xs-12" style="display: none" id="agregarAvion">
					<div class="white-box">
				...
				<div class="col-md-12 col-xs-12" style="display: none" id="gestionPrecios">
					<div class="white-box">
				...
				<div class="col-md-12 col-xs-12" style="display: none" id="agregarVuelos">
					<div class="white-box">
	...
	<script>
		$("#verTicket").click(function () {
			$("#gestionAvion").css("display","none");
			$("#agregarAvion").css("display","none");
			$("#gestionVuelos").css("display","none");
			$("#gestionPrecios").css("display","none");
			$("#tickest").css("display","block");
			$("#agregarVuelos").css("display","none");
			cargarVerTicker();
		});
